...
class CustomerHistoryAdapter(
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val layoutUlasan = view.findViewById<android.widget.LinearLayout>(R.id.layoutUlasanTerkirim)
        val tvRating     = view.findViewById<TextView>(R.id.tvIsiRating)
        val tvIsiUlasan  = view.findViewById<TextView>(R.id.tvIsiUlasan)

        val layoutQr  = view.findViewById<android.widget.LinearLayout>(R.id.layoutQrTicket)
        ...
        tvStatus.backgroundTintList = android.content.res.ColorStateList.valueOf(
            when (statusText) {
                ...
                "ON_PROGRESS", "PROCESSING" -> android.graphics.Color.parseColor("#E3F2FD")
    ...
    // ── DB helpers (pakai DBOpenHelper / tabel bookings lokal) ────────────────
